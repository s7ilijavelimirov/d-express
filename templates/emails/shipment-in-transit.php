...
<p><?php _e('Obaveštavamo Vas da je Vaša pošiljka trenutno u tranzitu.', 'd-express-woo'); ?></p>
...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1">
    ...
    <tr>
        <th scope="row" style="text-align: left; border: 1px solid #eee; padding: 12px;"><?php _e('Datum ažuriranja:', 'd-express-woo'); ?></th>
