    ...
    public function column_shipment_id($item) {
        ...
        $actions = [
            ...
            'print' => sprintf(
                ...
                admin_url(sprintf('admin-ajax.php?action=dexpress_download_label&shipment_id=%s&nonce=%s', 
                    $item['id'], 
            ...
            'delete' => sprintf(
                ...
                admin_url(sprintf('admin.php?page=dexpress-shipments&action=delete&shipment=%s&_wpnonce=%s', 
                    $item['id'], 
